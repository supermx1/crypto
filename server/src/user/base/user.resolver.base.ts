...
import { CaseFindManyArgs } from "../../case/base/CaseFindManyArgs";
...
export class UserResolverBase {
  ...
  async createUser(
    ...
    return await this.service.create({
      ...
      data: {
        ...
        privateInvestigators: args.data.privateInvestigators
          ? {
              connect: args.data.privateInvestigators,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => PrivateInvestigator, { nullable: true })
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "read",
    possession: "any",
  ...
  async privateInvestigators(
    ...
    const result = await this.service.getPrivateInvestigators(parent.id);
