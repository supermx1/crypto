...
import { CaseWhereInput } from "../../case/base/CaseWhereInput";
...
export class UserControllerBase {
  ...
  async create(
    ...
    return await this.service.create({
      data: {
        ...
        privateInvestigators: data.privateInvestigators
          ? {
              connect: data.privateInvestigators,
            }
          : undefined,
      },
      select: {
  ...
  async findManyCases(
    ...
    const query: CaseWhereInput = request.query;
    const permission = this.rolesBuilder.permission({
      role: userRoles,
      action: "read",
      possession: "any",
